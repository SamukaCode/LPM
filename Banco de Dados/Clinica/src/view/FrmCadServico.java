 ...
 * @author aluno
 */
public class FrmCadServico extends javax.swing.JFrame {

    /**
     * Creates new form FrmCadServico
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmCadServico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmCadServico().setVisible(true);
            }
        });
    }
